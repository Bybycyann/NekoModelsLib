...
execute if score #click nkTemp matches 0 as @e[tag=nkworkblock,tag=nktemp] at @s align xyz run data remove block ~ ~ ~ Items[{Slot:0b}].components."minecraft:custom_data"
